...
alter table filme modify duracao decimal not null,
alter estreia set default '2022-01-01';

alter table diretor modify nome_diretor varchar(50) not null;
alter table diretor add column rua varchar(50),
add bairro varchar(20),
add cidade Varchar(30),
add cep decimal(11),
add cpf decimal(11),
add telefone decimal(12);

alter table genero modify nome_genero varchar(30);
alter table genero alter nome_genero set default 'comédia';

alter table locacao add column data_entrega date;

/*Questão3:*/
insert into locacao values
(1, 1111, 300, 5.00, '2016-05-01', '2016-05-02'),
(2, 1111, 300, 5.00, '2016-05-01', '2016-05-02'),
(3, 1111, 300, 5.00, '2016-05-01', '2016-05-02'),
(4, 1111, 300, 5.00, '2016-05-01', '2016-05-02'),
(5, 1111, 300, 5.00, '2016-05-01', '2016-05-02'),
(6, 1111, 300, 5.00, '2016-05-01', '2016-05-02');

/*Questão4:*/
alter table locacao add constraint fk_locacao_cliente foreign key(codigo_cliente) references cliente(codigo_cliente);
